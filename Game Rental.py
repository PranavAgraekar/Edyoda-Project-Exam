                        ...
                        if content[j]["id"] == user_id:
                            ...
                            if (payment == final_price):
                                ...
                                if date not in content[j]["order_history"]:
                                    ...
                                    content[j]["order_history"][date].extend([content1[i]["Product Title"],quantity,final_price])
                                else:
                                    (content[j]["order_history"][date]).extend([content1[i]["Product Title"],quantity,final_price])
                                    break
                            else:
                            ...
                            if content["password"] == password:
                                while True:
                                    ...
                                    if val3 == "1":
                                        ...
                                        obj.create_product('Products.json', product_name, no_products, price, discount, product_type)
                                        break
                                    elif val3 == "2":
                                        obj.update_product()
                                        break
                                    ...
                                    while True:
                                        ...
                                        if val3 == "1":
                                            ...
                                            if val_a == 'A':
                                                ...
                                                obj.user_wishlist("Users.json", "Products.json", user_id, product_name,quantity)
                                            else:
                                            ...
                                            if val_a == 'A':
                                                ...
                                                product_name = input("Enter the Product You want to Purchase: ")
                                                quantity = int(input("Enter the quantity of Products: "))
                                                obj.user_cart("Users.json", "Products.json", user_id, product_name,quantity)
                                            else:
                                                user_id = user_id = int(input("Enter User Id:"))
                                            ...
                                            product_name = input("Enter the Product You want to Purchase: ")
                                            quantity = int(input("Enter the quantity of Products: "))
                                            obj.user_place_order("Users.json", "Products.json", user_id, product_name, quantity)
                                        elif val3 == "5":
                                            user_id = int(input("Enter User Id:"))
